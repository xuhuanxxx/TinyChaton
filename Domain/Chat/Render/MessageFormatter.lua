...
function addon.MessageFormatter.BuildRealtimeLineFromChatData(chatData)
    ...
    local channelBaseName = (chatType == "CHANNEL" and resolver and type(resolver.ResolveEventChannelName) == "function")
        and resolver.ResolveEventChannelName(chatData.channelName, chatData.channelString, chatData.channelNumber)
        or ((chatType == "CHANNEL") and chatData.channelName or nil)
